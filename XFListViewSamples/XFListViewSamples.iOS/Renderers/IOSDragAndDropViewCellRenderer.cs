...
using XFListViewSamples.iOS.Renderer;

[assembly: ExportRenderer(typeof(DraggableViewCellControl), typeof(IOSDragAndDropViewCellRenderer))]
namespace XFListViewSamples.iOS.Renderer
{
    public class IOSDragAndDropViewCellRenderer : ViewCellRenderer
    {
        ...
        private class LongPressGestureRecognizer : UILongPressGestureRecognizer
        {
            ...
            private static void OnRecognizing(LongPressGestureRecognizer recognizer, UITableView tableView, ViewCell cell)
            {
                ...
                if (cell.Parent is DraggableListViewControl)
                {
                    dragDropItemHighlightColor = (cell.Parent as DraggableListViewControl).DraggingColor;
                }
                ...
                switch (recognizer.State)
                {
                    case UIGestureRecognizerState.Began:
                        ...
                        if (indexPath != null)
                        {
                            ...
                            var tempColor = cell.View.BackgroundColor;
                            //Set the dragging color then once capture done, reset this color
                            cell.View.BackgroundColor = dragDropItemHighlightColor;
                    ...
                    case UIGestureRecognizerState.Ended:
                        ...
                        {
                            if (IOSDragAndDropListViewRenderer.ListMap.ContainsKey(tableView.Tag.ToString()) && IOSDragAndDropListViewRenderer.ListMap.ContainsKey(destinationTableView.Tag.ToString()))
                            {
                                var sourceList = (IList)IOSDragAndDropListViewRenderer.ListMap[tableView.Tag.ToString()].Item2;
                                var destinationList = (IList)IOSDragAndDropListViewRenderer.ListMap[destinationTableView.Tag.ToString()].Item2;
